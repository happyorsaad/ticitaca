...
class WebSocketTransport extends import_core.Transport {
  ...
  async onConnection(rawClient, req) {
    ...
    try {
      console.log("onConnection", roomId, sessionId, parsedURL.searchParams.get("reconnectionToken"));
      console.log(upgradeReq.url, parsedURL.searchParams.get("reconnectionToken"));
