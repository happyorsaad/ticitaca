...
class Room {
  ...
  checkReconnectionToken(reconnectionToken) {
    ...
    console.log("checkReconnectionToken", reconnectionToken, reconnection, sessionId, this.reservedSeats[sessionId]);
    console.log(this.hasReservedSeat(sessionId));
    if (this.hasReservedSeat(sessionId)) {
      this._reconnectingSessionId.set(sessionId, reconnectionToken);
      console.log(this._reconnectingSessionId);
      return sessionId;
    } else {
      return void 0;
    }
